...
const CoordinatorList = () => {
  ...
  return (
    <div className=" flec flex-col justify-center mx-auto items-center w-full h-full py-5 space-y-[40px] ">
      <p className="UpcommingEvents text-2xl md:text-4xl text-center font-semibold text-white">
          Faculty Coordinators (Akanksha 2024)
        </p>
      {loading && (
      ...
      <iframe
        src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT7TIIaUjeAHJNkoEhiCbR8nd__y25IIyla_6oA9lJsFaZmulRZp3sYt3e1F64FNW74vPMSMbIZCYGP/pubhtml?widget=true&amp;headers=false"
