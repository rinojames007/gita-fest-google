      ...
      <div className="bg-white h-full border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700  w-full ">
        ...
        <div className="p-5">
          ...
          <div className="flex justify-center mt-8 items-center">
            ...
            <Link
              to={props.redirect}
              className="flex items-center justify-center px-9 w-[80%] py-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Register
            </Link>
          </div>
