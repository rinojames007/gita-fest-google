  ...
  return (
    <div className="pt-[50px] flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col sm:flex-row justify-around items-center w-full py-[50px]">
        <Link to="/ahwan" className="w-[95%] sm:w-[30%] transition-transform transform hover:scale-105 focus:scale-105">
          <EventCard name="Ahwan" url={"https://i.postimg.cc/VNyszV4H/sports.webp"} />
        </Link>

        <Link to="/anwesh" className="w-[95%] sm:w-[30%] transition-transform transform hover:scale-105 focus:scale-105">
          <EventCard name="Anwesh" url={"https://i.postimg.cc/yYd8j9kn/tech.webp"} />
        </Link>

        <Link to="/akanksha" className="w-[95%] sm:w-[30%] transition-transform transform hover:scale-105 focus:scale-105">
