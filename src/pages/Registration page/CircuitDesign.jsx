      ...
      <div className="bg-gradient-to-b from-[#161b29] via-purple-900 to-[#161b29] h-full min-h-screen">
        ...
        <div className="py-20">
          <h1 className="text-white text-center font-bold md:text-5xl text-2xl my-5">
            Register For FUN WITH ELECTRONIC CIRCUITS
          </h1>
          {loading && (
          ...
          <iframe
            src="https://docs.google.com/forms/d/e/1FAIpQLSe8baiYFNkzuz_4h4SLdLln_gGz8szfibCQ8v9HXC-4DRziDw/viewform?embedded=true"
